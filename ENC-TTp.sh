...
#TOOLS VERSI 1.0 DI BUAT TANGGAL 27 AGUSTUS 2023
...
TIME=`date "+%H:%M"`
neofetch
echo -e ${GREEN}"Time : " $TIME
echo -e ${GREEN}"date " $NOW 
echo
echo -e "          ${RED}[ ${WHITE} SEPESIFIKASI HP TUAN ADA DI ATAS TERIMA AKSIH ${RED}]"
sleep 3
...
echo "         ${RED}[ ${WHITE} SELAMAT DATANG DI FROM UCH 2009 FROM COMUNITY TUAN ${RED}]"
...
echo -e ${GREEN} "██ ▀ ██  █▀█▀▀▀▀█  █  ${WHITE}╠═╝ ╠═╣ ╚═╗ ╚═╗ ║║║ ║ ║ ╠╦╝  ║║   ║   ║ ║ ║ ╦ ║ ║║║  "
echo -e ${GREEN} "███▄███  ▀ ▀     ▀▀   ${WHITE}╩┈┈ ╩┈╩ ╚═╝ ╚═╝ ╚╩╝ ╚═╝ ╩╚═ ═╩╝   ╩═╝ ╚═╝ ╚═╝ ╩ ╝╚╝  "
echo -e $w"        ╔══╝ ╚════╗    ${WHITE}password login ada di Grup Whastapp Gabung dulu tuan "

# link buat download password 

echo " "
echo "${WHITE}LINK PASSWORD BUAT LOGIN => ${ORANGE} ada di Grup WhatsApp Gabung Dulu tuan "
echo "${WHITE}NOTE => BUAT PASSWORD ADA DI LINK YG SAYA SUDAH SEDIAKAN!"
echo " "
...
echo -e " ║  ║ ║ ║ ║ ║     ╠╣  ╠╦╝ ║ ║ ║║║   ║ ║ ║   ╠═╣  "
echo -e " ╩  ╚═╝ ╚═╝ ╩═╝   ╚   ╩╚═ ╚═╝ ╩┈╩   ╚═╝ ╚═╝ ╩┈╩  "
echo "${WHITE}[${GREEN} TIPE RUNING TOOLS TERMUX , LINUX , NETHUNTER ${WHITE}]"
echo " "
...
sleep 1s
echo  " "
echo "${BLUE}[${RED}!${BLUE}] ${GREEN}Tuan Mengunakan Software Termux saat masuk Script Update  "
sleep 1s
echo "${BLUE}[${RED}✓${BLUE}] ${GREEN}Loading Installing Update in Termux.."
    echo " "
      sleep 2s
